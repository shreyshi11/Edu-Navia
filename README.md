...
- **Backend/Data:** Firebase Firestore, Firebase Auth, Firebase Storage,Fast API,Uvicorn Server
- **AI/ML:** Random Forest, XGBosst
- **AI/Integration:**
  - Gemini API (Chatbot)
...
LINK OF OUR DEPLOYED SITE:: https://edunavia.onrender.com/
